...
const TEXT_SURFACE_PARAM_KEYS = new Set([
  ...
  "rebaje_lateral_product_ids",
  "leaf_lateral_rebaje_product_ids",
  "lateral_rebate_product_ids",
  "door_product_ids",
  "puerta_product_ids",
  ...
  "left_door_product_ids",
  "puerta_izquierda_product_ids",
  "door_left_product_ids",
]);
...
const SURFACE_PARAM_ALIASES = {
  ...
  parantes_left_door_product_ids: ["parantes_left_door_product_ids", "left_door_product_ids", "puerta_izquierda_product_ids", "door_left_product_ids"],
  hoja_rebaje_lateral_product_ids: ["hoja_rebaje_lateral_product_ids", "rebaje_lateral_product_ids", "leaf_lateral_rebaje_product_ids", "lateral_rebate_product_ids"],
...
function pickParantesConfig(params = {}) {
  ...
  return {
    ...
    parantes_left_door_product_ids: normalizeText(normalized.parantes_left_door_product_ids),
